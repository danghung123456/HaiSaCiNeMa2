...
public class EmailServiceImpl implements EmailService {
	...
	public void sendMail(String to, String subject, String text, Multipart mp) {
		try {
			...
			String text = "<b>Đây là mã code của quý khách: (Xin vui lòng không chia sẻ với bất kỳ ai)</b>" + "<div><img src=\"cid:" + cid + "\" /></div></html>"
					+ "<br><b>Thông tin vé: </b>" 
					+ "<br>	&emsp;&emsp;Số lượng vé: " + ticket.getTicketQuantity() 
					+ "<br>	&emsp;&emsp;Tên phim: "+ ticket.getShowtimes().getMovie().getMovieName() 
					+ "<br> &emsp;&emsp;Giờ chiếu: "+ ticket.getShowtimes().getPeriod().getStartTime() 
					+ "<br> &emsp;&emsp;Tên rạp: " + ticket.getShowtimes().getRoom().getCinema().getName() 
					+ "<br> &emsp;&emsp;Tên phòng: " + ticket.getShowtimes().getRoom().getRoomName() 
					+ "<br> &emsp;&emsp;Ngày chiếu: " + ticket.getShowtimes().getDate() 
					+ "<br> &emsp;&emsp;Số ghế: " + listSeat 
					+ "<br> &emsp;&emsp;Đồ ăn, nước uống: <br>" + listFood 
					+ "<br><b>Tổng tiền: " + ticket.getTotal() + "</b>" 
					+ "<br>Cám ơn quý khách, chúc quý khách xem phim vui vẻ";
